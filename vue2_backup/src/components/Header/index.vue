 ...
 * @Description: 页面头部组件 - 包含音乐播放器和导航
 * @FilePath: /my_blog/src/components/Header/index.vue
-->
<template>
  <div class="header" ref="headRef">
    <div class="left flex align-center">
      <img @click="toIndex" src="@img/textlogo.png" alt="Logo" />
      <i
        class="iconfont"
        @click="changeMusic"
...
const listenPlay = () => {
  ...
  audioDom.value.ontimeupdate = () => {
    const currentTime = (
      (audioDom.value.currentTime / audioDom.value.duration) *
      100
    ).toFixed(0)
    progressBarWidth.value = currentTime
  }
}
