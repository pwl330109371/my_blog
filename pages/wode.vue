      ...
      <div class="me flex">
        <div class="block flex align-center">
          ...
          <div class="hide-block">
            <img
              src="https://thewind-1302955814.cos.ap-shanghai.myqcloud.com/rainy/%E5%BE%AE%E4%BF%A1%E5%9B%BE%E7%89%87_20210415142905.jpg"
              alt="微信二维码"
            />
          </div>
        </div>
...
// useUserApi auto-imported: getAboutMe
...
const getDetail = async () => {
  try {
    ...
    if (data && data.content) {
        markdownRender(data.content)
    }
  } catch (error) {
    console.error('获取关于我失败:', error)
  }
}
...
// Removed import 'highlight.js/styles/monokai-sublime.css' -> Handled globally in nuxt config or specific plugin
